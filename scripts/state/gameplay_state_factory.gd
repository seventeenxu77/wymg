...
static func actor(
	...
	var state := {
		...
		"scout_scan_until": 0.0,
		"scout_last_known_room": Vector2i(-1, -1),
		"scout_last_known_until": 0.0,
		"support_heal_progress": 0.0,
		"support_heal_target_peer_id": 0,
		"medical_fatigue_until": 0.0,
		"hauler_sprint_until": 0.0,
		"rescue_required_seconds": 2.5,
		"last_voice_at": -10.0,
		"hp": 2,
		"moving": false,
